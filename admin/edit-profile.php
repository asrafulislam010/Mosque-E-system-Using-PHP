...
if(isset($_POST['update']))
{
    ...
    $phone=$_POST['phone'];
$userid=$_GET['uid'];
    $msg=mysqli_query($con,"update usertable set name='$name',address='$address',phone='$phone' where id='$userid'");

if($msg)
{
    echo "<script>alert('Profile updated successfully');</script>";
       echo "<script type='text/javascript'> document.location = 'manage-user.php'; </script>";
};
};
...
<?php 
$userid=$_GET['uid'];
$query=mysqli_query($con,"SELECT * FROM usertable WHERE id='$userid'");
                                ...
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       ...
                                       <td><input class="form-control" id="address" name="address" type="text" value="<?php echo $result['address'];?>"  required /></td>
                                         ...
                                         <tr>
                                       <th>Phone</th>
                                       <td colspan="3"><input class="form-control" id="phone" name="phone" type="text" value="<?php echo $result['phone'];?>"  pattern="[0-9]{10}" title="10 numeric characters only"  maxlength="10" required /></td>
                                   </tr>
                                   <tr>
                                       <th>Email</th>
